...
public class EscritorWrapper implements Escritor, ModelWrapper<Escritor> {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<tutoriales.liferay.crud.libro.model.Escritor> toCacheModel() {
		return _escritor.toCacheModel();
	}

	@Override
	public int compareTo(tutoriales.liferay.crud.libro.model.Escritor escritor) {
	...
	*/
	...
	@Override
	public tutoriales.liferay.crud.libro.model.Escritor toEscapedModel() {
		return new EscritorWrapper(_escritor.toEscapedModel());
	}

	@Override
	public tutoriales.liferay.crud.libro.model.Escritor toUnescapedModel() {
