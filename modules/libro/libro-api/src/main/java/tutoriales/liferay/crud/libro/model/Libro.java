 ...
 * @generated
 */
@ImplementationClassName("tutoriales.liferay.crud.libro.model.impl.LibroImpl")
@ProviderType
public interface Libro extends LibroModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link tutoriales.liferay.crud.libro.model.impl.LibroImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
