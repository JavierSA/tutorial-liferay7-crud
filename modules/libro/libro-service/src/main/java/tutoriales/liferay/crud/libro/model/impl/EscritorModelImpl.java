...
import tutoriales.liferay.crud.libro.model.EscritorModel;
...
public class EscritorModelImpl extends BaseModelImpl<Escritor>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(tutoriales.liferay.crud.libro.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.tutoriales.liferay.crud.libro.model.Escritor"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(tutoriales.liferay.crud.libro.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.tutoriales.liferay.crud.libro.model.Escritor"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(tutoriales.liferay.crud.libro.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.tutoriales.liferay.crud.libro.model.Escritor"),
			true);
	...
	public static final boolean FINDER_CACHE_ENABLED_LIBRO_LIBROS_ESCRITORES = GetterUtil.getBoolean(tutoriales.liferay.crud.libro.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.LIBRO_Libros_Escritores"),
			true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(tutoriales.liferay.crud.libro.service.util.ServiceProps.get(
				"lock.expiration.time.tutoriales.liferay.crud.libro.model.Escritor"));
	...
	public String toXmlString() {
		...
		sb.append("tutoriales.liferay.crud.libro.model.Escritor");
