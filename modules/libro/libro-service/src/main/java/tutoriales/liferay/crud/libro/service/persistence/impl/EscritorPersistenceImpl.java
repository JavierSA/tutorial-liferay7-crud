...
package tutoriales.liferay.crud.libro.service.persistence.impl;
...
import tutoriales.liferay.crud.libro.exception.NoSuchEscritorException;
import tutoriales.liferay.crud.libro.model.Escritor;
import tutoriales.liferay.crud.libro.model.impl.EscritorImpl;
import tutoriales.liferay.crud.libro.model.impl.EscritorModelImpl;
 ...
 * @see tutoriales.liferay.crud.libro.service.persistence.EscritorUtil
 * @generated
 */
@ProviderType
public class EscritorPersistenceImpl extends BasePersistenceImpl<Escritor>
	 ...
	 */
	@Override
	public List<tutoriales.liferay.crud.libro.model.Libro> getLibros(long pk) {
	...
	public List<tutoriales.liferay.crud.libro.model.Libro> getLibros(long pk,
		int start, int end,
		OrderByComparator<tutoriales.liferay.crud.libro.model.Libro> orderByComparator) {
	...
	public void addLibros(long pk,
		List<tutoriales.liferay.crud.libro.model.Libro> libros) {
		addLibros(pk,
			ListUtil.toLongArray(libros,
				tutoriales.liferay.crud.libro.model.Libro.LIBRO_ID_ACCESSOR));
	}
	...
	public void setLibros(long pk,
		...
		try {
			...
			for (int i = 0; i < libros.size(); i++) {
				tutoriales.liferay.crud.libro.model.Libro libro = libros.get(i);
	...
	protected TableMapper<Escritor, tutoriales.liferay.crud.libro.model.Libro> escritorToLibroTableMapper;
