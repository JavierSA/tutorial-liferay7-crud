...
import tutoriales.liferay.crud.libro.exception.NoSuchLibroException;
import tutoriales.liferay.crud.libro.model.Libro;
import tutoriales.liferay.crud.libro.model.impl.LibroImpl;
import tutoriales.liferay.crud.libro.model.impl.LibroModelImpl;
 ...
 * @see tutoriales.liferay.crud.libro.service.persistence.LibroUtil
 * @generated
 */
@ProviderType
public class LibroPersistenceImpl extends BasePersistenceImpl<Libro>
	 ...
	 */
	@Override
	public List<tutoriales.liferay.crud.libro.model.Escritor> getEscritors(
		long pk) {
	...
	public void addEscritors(long pk,
		...
		addEscritors(pk,
			ListUtil.toLongArray(escritors,
				tutoriales.liferay.crud.libro.model.Escritor.ESCRITOR_ID_ACCESSOR));
	}
	...
	public void setEscritors(long pk,
		...
		try {
			...
			for (int i = 0; i < escritors.size(); i++) {
				tutoriales.liferay.crud.libro.model.Escritor escritor = escritors.get(i);
	...
	protected TableMapper<Libro, tutoriales.liferay.crud.libro.model.Escritor> libroToEscritorTableMapper;
